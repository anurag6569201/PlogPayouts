...
import 'package:solution_challenge_app/location_details_favourites.dart';

class locationGridItemFavourite extends StatelessWidget {
  locationGridItemFavourite(this.category, {super.key});
  ...
  void _onSelectCategory(BuildContext context) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (ctx) => locationDetailsFavourite(category),
      ),
    );
  }
